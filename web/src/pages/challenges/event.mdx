...
---
### 12. popstate Event for Managing History in SPAs

The popstate event is used in SPAs to handle back and forward navigation.
...
<head>
    <meta charset="UTF-8">
    <title>Popstate Event Example</title>
</head>
<body>
    ...
    <script>
        ...
        window.addEventListener('popstate', () => {
            console.log(`Back or forward to: ${location.pathname}`);
        });
    </script>
</body>
</html>
